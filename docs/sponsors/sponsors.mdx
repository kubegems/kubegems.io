...
hide_title: true
sidebar_position: 1
description:  KubeGems感谢信和赞助说明
keywords: [kubegems,sponsors]
---
...
<table>
    <tr>
      <td width="30%" align="center"><b>Weixin</b></td>
      <td width="30%" align="center"><b>Alipay</b></td>
    </tr>
    <tr>
        <td width="30%" align="center"><img src={require('./assets/weixin.jpg').default} width="70%"/></td>
        <td width="30%" align="center"><img src={require('./assets/alipay.jpg').default} width="70%"/></td>
    </tr>
</table>
